...
/**
 * Schema for CodeForceResponse object
 */
...
const typeMap: any = {
  Coordinate: o(
    [
      ...
      { json: "durationSeconds", js: "durationSeconds", typ: 0 },
      { json: "forzen", js: "forzen", typ: true },
      {
        json: "freezeDurationSeconds",
        js: "freezeDurationSeconds",
        typ: u(undefined, 0),
      },
      { json: "icpcRegion", js: "icpcRegion", typ: u(undefined, "") },
      { json: "id", js: "id", typ: 0 },
      { json: "kind", js: "kind", typ: u(undefined, "") },
      { json: "name", js: "name", typ: "" },
      { json: "phase", js: "phase", typ: r("Phase") },
      { json: "preparedBy", js: "preparedBy", typ: u(undefined, "") },
      {
        json: "relativeTimeSeconds",
        js: "relativeTimeSeconds",
        typ: u(undefined, 0),
      },
